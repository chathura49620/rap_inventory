...
const VendorProduct = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:9000/api/v1/vendor-product').then((res) => {
    ...
    const handleAddOrEdit = (type, data) => {
        if (type === 'add') {
            axios.post('http://localhost:9000/api/v1/vendor-product', data).then((res) => {
                console.log(res.data);
            ...
            axios.put('http://localhost:9000/api/v1/vendor-product', data).then((res) => {
                console.log(res.data);
                setRefreshTable(prev => !prev);
            }).catch(err => {
                console.error(err);
    ...
    const deleteProduct = () => {
        console.log(delId)
        axios.delete(`http://localhost:9000/api/v1/vendor-product/${delId}`).then((res) => {
            console.log(res.data);
            setRefreshTable(prev => !prev);
        }).catch(err => {
            console.error(err);
